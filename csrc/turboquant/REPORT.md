...
### KV Cache Quantization PPL

| Model | Params | seq_len | FP16 PPL | TQ-4bit KV PPL | Change |
|-------|--------|---------|----------|----------------|--------|
| Llama-3-8B | 8.0B | 4096 | 6.12 | 6.32 | +3.3% |
| **DeepSeek-R1-0528** | **671B** | 512 | 2.7748 | 2.7748 | **+0.00%** |
| **DeepSeek-R1-0528** | **671B** | 1024 | 2.7305 | 2.7305 | **+0.00%** |
| **DeepSeek-R1-0528** | **671B** | 2048 | 1.9836 | 1.9836 | **+0.00%** |

**Key finding**: TurboQuant 4-bit KV cache is **completely lossless** on DeepSeek-R1 (671B, MLA, kv_lora_rank=512). The quantization error at d=512 is too small to affect PPL. This confirms the theoretical prediction: at b=4 bits, the Lloyd-Max distortion D_mse=0.009 is negligible for large models.
